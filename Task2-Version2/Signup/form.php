					...
					<div class="border-right">
						<div class="border-left">
							<div class="inner">
								...
								<div class="address">
									<h2 style="color:#FFFFFF;">Please , sign Up to show movies..  </h2>
								</div>
							</div>
						</div>
					</div>
...
/*#create DB
	...
	if(!$db)
	{
		...
		{
			echo "DataBase created succssefully <br>";
		}
		else
		{
			echo "Error created DB:" . mysql_error()."<br>";
		}
	}*/
$s =mysql_select_db('User',$link);
/*#create table
	$sql="CREATE table signup (UserName varchar(20) not null,Password VARCHAR(50) not null,Email varchar(20) null,Mobile varchar(20) null)";
...
if(isset($_POST["submit"]))
{
  ...
  $sql=" insert into signup (UserName,Password,Email,Mobile) VALUES ( '$UserName', '$Password', '$Email' ,'$Mobile')";
